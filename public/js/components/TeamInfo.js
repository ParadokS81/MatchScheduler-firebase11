...
const TeamInfo = (function() {
            ...
            <div class="space-y-2">
                ...
                <div class="text-center py-2">
                    ...
                    <div class="flex flex-row gap-2 px-2">
                        <button id="teaminfo-discord-signin" class="flex-1 font-medium py-2 px-2 rounded-md transition-colors flex items-center justify-center gap-1.5 text-sm" type="button" style="background-color: #5865F2; color: white;">
                        ...
                        <button id="teaminfo-google-signin" class="flex-1 font-medium py-2 px-2 rounded-md transition-colors flex items-center justify-center gap-1.5 text-sm border" type="button" style="background-color: transparent; color: var(--foreground); border-color: var(--border);">
    ...
    function _attachEventListeners() {
        ...
        const discordBtn = _panel.querySelector('#teaminfo-discord-signin');
        if (discordBtn) {
        ...
        const googleBtn = _panel.querySelector('#teaminfo-google-signin');
        if (googleBtn) {
